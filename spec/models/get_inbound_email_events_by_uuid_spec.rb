...
# Unit tests for SibApiV3Sdk::GetInboundEmailEventsByUuid
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInboundEmailEventsByUuid' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetInboundEmailEventsByUuid.new
  end
  ...
  describe 'test an instance of GetInboundEmailEventsByUuid' do
    it 'should create an instance of GetInboundEmailEventsByUuid' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetInboundEmailEventsByUuid)
    end
  end
