...
# Unit tests for SibApiV3Sdk::MasterDetailsResponseBillingInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterDetailsResponseBillingInfo' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::MasterDetailsResponseBillingInfo.new
  end
  ...
  describe 'test an instance of MasterDetailsResponseBillingInfo' do
    it 'should create an instance of MasterDetailsResponseBillingInfo' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::MasterDetailsResponseBillingInfo)
    end
  end
