...
# Unit tests for SibApiV3Sdk::ConversationsMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConversationsMessage' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::ConversationsMessage.new
  end
  ...
  describe 'test an instance of ConversationsMessage' do
    it 'should create an instance of ConversationsMessage' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::ConversationsMessage)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["agent", "visitor"])
  ...
  describe 'test attribute "is_pushed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
