...
# Unit tests for SibApiV3Sdk::FileDownloadableLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FileDownloadableLink' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::FileDownloadableLink.new
  end
  ...
  describe 'test an instance of FileDownloadableLink' do
    it 'should create an instance of FileDownloadableLink' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::FileDownloadableLink)
    end
  end
