...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesLandingPage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoFeaturesLandingPage' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesLandingPage.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoFeaturesLandingPage' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoFeaturesLandingPage' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesLandingPage)
    end
  end
