...
# Unit tests for SibApiV3Sdk::GetExtendedContactDetailsStatisticsDelivered
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedContactDetailsStatisticsDelivered' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetExtendedContactDetailsStatisticsDelivered.new
  end
  ...
  describe 'test an instance of GetExtendedContactDetailsStatisticsDelivered' do
    it 'should create an instance of GetExtendedContactDetailsStatisticsDelivered' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetExtendedContactDetailsStatisticsDelivered)
    end
  end
