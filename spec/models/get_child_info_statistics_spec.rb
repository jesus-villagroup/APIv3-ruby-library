...
# Unit tests for SibApiV3Sdk::GetChildInfoStatistics
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetChildInfoStatistics' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetChildInfoStatistics.new
  end
  ...
  describe 'test an instance of GetChildInfoStatistics' do
    it 'should create an instance of GetChildInfoStatistics' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetChildInfoStatistics)
    end
  end
  ...
  describe 'test attribute "current_month_total_sent"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
