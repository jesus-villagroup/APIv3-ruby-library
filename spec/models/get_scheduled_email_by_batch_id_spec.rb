...
# Unit tests for SibApiV3Sdk::GetScheduledEmailByBatchId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetScheduledEmailByBatchId' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetScheduledEmailByBatchId.new
  end
  ...
  describe 'test an instance of GetScheduledEmailByBatchId' do
    it 'should create an instance of GetScheduledEmailByBatchId' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetScheduledEmailByBatchId)
    end
  end
