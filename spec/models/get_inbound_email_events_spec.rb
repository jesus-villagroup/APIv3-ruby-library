...
# Unit tests for SibApiV3Sdk::GetInboundEmailEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInboundEmailEvents' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetInboundEmailEvents.new
  end
  ...
  describe 'test an instance of GetInboundEmailEvents' do
    it 'should create an instance of GetInboundEmailEvents' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetInboundEmailEvents)
    end
  end
