...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCreditsEmails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoCreditsEmails' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCreditsEmails.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoCreditsEmails' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoCreditsEmails' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCreditsEmails)
    end
  end
