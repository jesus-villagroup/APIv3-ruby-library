...
# Unit tests for SibApiV3Sdk::GetExtendedContactDetails
...
describe 'GetExtendedContactDetails' do
  ...
  describe 'test an instance of GetExtendedContactDetails' do
    it 'should create an instance of GetExtendedContactDetails' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetExtendedContactDetails)
    end
  end
  ...
  describe 'test attribute "list_unsubscribed"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
