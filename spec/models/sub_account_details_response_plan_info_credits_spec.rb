...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCredits
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoCredits' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCredits.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoCredits' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoCredits' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoCredits)
    end
  end
