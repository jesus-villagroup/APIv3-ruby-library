...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesInbox
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoFeaturesInbox' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesInbox.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoFeaturesInbox' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoFeaturesInbox' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesInbox)
    end
  end
