...
# Unit tests for SibApiV3Sdk::GetInboundEmailEventsEvents
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInboundEmailEventsEvents' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetInboundEmailEventsEvents.new
  end
  ...
  describe 'test an instance of GetInboundEmailEventsEvents' do
    it 'should create an instance of GetInboundEmailEventsEvents' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetInboundEmailEventsEvents)
    end
  end
