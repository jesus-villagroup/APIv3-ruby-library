...
# Unit tests for SibApiV3Sdk::MasterDetailsResponseBillingInfoAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterDetailsResponseBillingInfoAddress' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::MasterDetailsResponseBillingInfoAddress.new
  end
  ...
  describe 'test an instance of MasterDetailsResponseBillingInfoAddress' do
    it 'should create an instance of MasterDetailsResponseBillingInfoAddress' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::MasterDetailsResponseBillingInfoAddress)
    end
  end
