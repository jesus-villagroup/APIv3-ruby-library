...
# Unit tests for SibApiV3Sdk::MasterDetailsResponseBillingInfoName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterDetailsResponseBillingInfoName' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::MasterDetailsResponseBillingInfoName.new
  end
  ...
  describe 'test an instance of MasterDetailsResponseBillingInfoName' do
    it 'should create an instance of MasterDetailsResponseBillingInfoName' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::MasterDetailsResponseBillingInfoName)
    end
  end
