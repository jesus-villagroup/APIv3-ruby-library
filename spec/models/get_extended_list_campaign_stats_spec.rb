...
# Unit tests for SibApiV3Sdk::GetExtendedListCampaignStats
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedListCampaignStats' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetExtendedListCampaignStats.new
  end
  ...
  describe 'test an instance of GetExtendedListCampaignStats' do
    it 'should create an instance of GetExtendedListCampaignStats' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetExtendedListCampaignStats)
    end
  end
