...
# Unit tests for SibApiV3Sdk::ConversationsMessageFile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConversationsMessageFile' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::ConversationsMessageFile.new
  end
  ...
  describe 'test an instance of ConversationsMessageFile' do
    it 'should create an instance of ConversationsMessageFile' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::ConversationsMessageFile)
    end
  end
