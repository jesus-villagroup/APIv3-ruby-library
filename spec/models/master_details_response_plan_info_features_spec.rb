...
# Unit tests for SibApiV3Sdk::MasterDetailsResponsePlanInfoFeatures
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterDetailsResponsePlanInfoFeatures' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::MasterDetailsResponsePlanInfoFeatures.new
  end
  ...
  describe 'test an instance of MasterDetailsResponsePlanInfoFeatures' do
    it 'should create an instance of MasterDetailsResponsePlanInfoFeatures' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::MasterDetailsResponsePlanInfoFeatures)
    end
  end
