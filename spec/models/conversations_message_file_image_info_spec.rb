...
# Unit tests for SibApiV3Sdk::ConversationsMessageFileImageInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConversationsMessageFileImageInfo' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::ConversationsMessageFileImageInfo.new
  end
  ...
  describe 'test an instance of ConversationsMessageFileImageInfo' do
    it 'should create an instance of ConversationsMessageFileImageInfo' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::ConversationsMessageFileImageInfo)
    end
  end
