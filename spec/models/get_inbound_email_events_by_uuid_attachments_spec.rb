...
# Unit tests for SibApiV3Sdk::GetInboundEmailEventsByUuidAttachments
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetInboundEmailEventsByUuidAttachments' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetInboundEmailEventsByUuidAttachments.new
  end
  ...
  describe 'test an instance of GetInboundEmailEventsByUuidAttachments' do
    it 'should create an instance of GetInboundEmailEventsByUuidAttachments' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetInboundEmailEventsByUuidAttachments)
    end
  end
