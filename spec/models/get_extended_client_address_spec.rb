...
# Unit tests for SibApiV3Sdk::GetExtendedClientAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetExtendedClientAddress' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetExtendedClientAddress.new
  end
  ...
  describe 'test an instance of GetExtendedClientAddress' do
    it 'should create an instance of GetExtendedClientAddress' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetExtendedClientAddress)
    end
  end
