...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesUsers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoFeaturesUsers' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesUsers.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoFeaturesUsers' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoFeaturesUsers' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeaturesUsers)
    end
  end
