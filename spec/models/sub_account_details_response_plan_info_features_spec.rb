...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeatures
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfoFeatures' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeatures.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfoFeatures' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfoFeatures' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfoFeatures)
    end
  end
