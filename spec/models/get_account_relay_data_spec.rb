...
# Unit tests for SibApiV3Sdk::GetAccountRelayData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAccountRelayData' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetAccountRelayData.new
  end
  ...
  describe 'test an instance of GetAccountRelayData' do
    it 'should create an instance of GetAccountRelayData' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetAccountRelayData)
    end
  end
