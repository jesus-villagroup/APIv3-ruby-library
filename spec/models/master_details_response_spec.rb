...
# Unit tests for SibApiV3Sdk::MasterDetailsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MasterDetailsResponse' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::MasterDetailsResponse.new
  end
  ...
  describe 'test an instance of MasterDetailsResponse' do
    it 'should create an instance of MasterDetailsResponse' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::MasterDetailsResponse)
    end
  end
