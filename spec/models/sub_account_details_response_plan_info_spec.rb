...
# Unit tests for SibApiV3Sdk::SubAccountDetailsResponsePlanInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubAccountDetailsResponsePlanInfo' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::SubAccountDetailsResponsePlanInfo.new
  end
  ...
  describe 'test an instance of SubAccountDetailsResponsePlanInfo' do
    it 'should create an instance of SubAccountDetailsResponsePlanInfo' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::SubAccountDetailsResponsePlanInfo)
    end
  end
