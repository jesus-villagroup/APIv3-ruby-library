...
# Unit tests for SibApiV3Sdk::GetCampaignOverview
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCampaignOverview' do
  before do
    # run before each test
    @instance = SibApiV3Sdk::GetCampaignOverview.new
  end
  ...
  describe 'test an instance of GetCampaignOverview' do
    it 'should create an instance of GetCampaignOverview' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetCampaignOverview)
    end
  end
