...
# Unit tests for SibApiV3Sdk::GetCampaignRecipients
...
describe 'GetCampaignRecipients' do
  ...
  describe 'test an instance of GetCampaignRecipients' do
    it 'should create an instance of GetCampaignRecipients' do
      expect(@instance).to be_instance_of(SibApiV3Sdk::GetCampaignRecipients)
    end
  end
  ...
  describe 'test attribute "exclusion_lists"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
