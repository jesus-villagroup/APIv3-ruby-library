...
module SibApiV3Sdk
  class GetInboundEmailEventsByUuid
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deliveredAt')
        self.delivered_at = attributes[:'deliveredAt']
      end
    ...
    def hash
      [received_at, delivered_at, recipient, sender, message_id, subject, attachments, logs].hash
    end
