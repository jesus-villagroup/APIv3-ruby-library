...
module SibApiV3Sdk
  class GetContactCampaignStatsTransacAttributes
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderPrice')
        self.order_price = attributes[:'orderPrice']
      end
    ...
    def list_invalid_properties
      ...
      if @order_price.nil?
        invalid_properties.push('invalid value for "order_price", order_price cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @order_price.nil?
    ...
    def hash
      [order_date, order_price, order_id].hash
    end
