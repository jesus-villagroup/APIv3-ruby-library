...
module SibApiV3Sdk
  class AbTestCampaignResult
    ...
    attr_accessor :winning_criteria

    # Subject Line of current winning version
    attr_accessor :winning_subject_line
    ...
    # @param [Object] winning_version Object to be assigned
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] winning_criteria Object to be assigned
