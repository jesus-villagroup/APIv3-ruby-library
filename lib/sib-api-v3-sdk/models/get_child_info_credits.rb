...
module SibApiV3Sdk
  ...
  class GetChildInfoCredits
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emailCredits')
        self.email_credits = attributes[:'emailCredits']
      end

      if attributes.has_key?(:'smsCredits')
        self.sms_credits = attributes[:'smsCredits']
      end
    end
    ...
    def hash
      [email_credits, sms_credits].hash
    end
