...
module SibApiV3Sdk
  ...
  class TaskReminder
    ...
    def valid?
      ...
      unit_validator = EnumAttributeValidator.new('String', ['minutes', 'hours', 'weeks', 'days'])
    ...
    def unit=(unit)
      validator = EnumAttributeValidator.new('String', ['minutes', 'hours', 'weeks', 'days'])
