...
module SibApiV3Sdk
  class GetSmsEventReportEvents
    ...
    def event=(event)
      validator = EnumAttributeValidator.new('String', ['bounces', 'hardBounces', 'softBounces', 'delivered', 'sent', 'accepted', 'unsubscription', 'replies', 'blocked'])
    ...
    def hash
      [phone_number, date, message_id, event, reason, reply, tag].hash
    end
