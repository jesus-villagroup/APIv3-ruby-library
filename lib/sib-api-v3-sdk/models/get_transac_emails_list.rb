...
module SibApiV3Sdk
  class GetTransacEmailsList
    ...
    def self.swagger_types
      {
        :'count' => :'Integer',
        :'transactional_emails' => :'Array<GetTransacEmailsListTransactionalEmails>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transactionalEmails')
        if (value = attributes[:'transactionalEmails']).is_a?(Array)
          self.transactional_emails = value
        end
      end
    end
    ...
    def hash
      [count, transactional_emails].hash
    end
