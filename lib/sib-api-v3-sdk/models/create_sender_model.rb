...
module SibApiV3Sdk
  class CreateSenderModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'spfError')
        self.spf_error = attributes[:'spfError']
      end

      if attributes.has_key?(:'dkimError')
        self.dkim_error = attributes[:'dkimError']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          spf_error == o.spf_error &&
          dkim_error == o.dkim_error
    end
