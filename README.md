# Brevo's API v3 Ruby Library (Formerly Sendinblue's API v3 Ruby Library) 
...
Be sure to visit the Brevo official [documentation website](https://developers.brevo.com/docs ) for additional information about our API.
